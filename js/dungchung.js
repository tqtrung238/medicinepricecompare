...
function addProduct(p, ele, returnString) {
	...
	product = new Product(p.masp, p.name, p.img, p.price, p.star, p.rateCount, promo, p.link); // Class product
	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="trungtambaohanh.html"><i class="fa fa-wrench"></i> Danh sách</a></li>
...
function addFooter() {
    ...
    <div class="copy-right">
        <p><a href="index.html"> Copyright © 2022 Medigo Software</a> - All rights reserved</p>
    </div>`);
}
